...
public class AdvanceActivity extends AppCompatActivity {
    public static final String PROGRESSIVE_JPEG = "http://hydro.electric.gen.nz/photos/hvhs/leaving%20photograph/hvhs-7-1999-300dpi-optimised-progressive-jpeg.jpg";
    ...
    private void initFresco() {
        ...
        //下面这个是Android默认的网络请求
        ImagePipelineConfig imagePipelineConfig2 = ImagePipelineConfig.newBuilder(this)
                .setProgressiveJpegConfig(progressiveJpegConfig)
                .build();
    ...
    private void initDraweeHierarchy() {
        ...
        GenericDraweeHierarchy hierarchy = builder
                ...
                .setPlaceholderImage(ContextCompat.getDrawable(getApplicationContext(),R.color.placeholder))
                .setFailureImage(ContextCompat.getDrawable(getApplicationContext(),R.color.error))
    ...
    private void loadLow2HighImages() {
        Uri lowUri = Uri.parse("http://images2.gamme.com.tw/news2/2011/21/31/p56YoaGXlqWW.jpg");
    ...
    private void loadThumbnailPreview() {
        Uri uri = Uri.parse(UriUtil.LOCAL_RESOURCE_SCHEME+"://" + getResources().getResourcePackageName(R.drawable.loal_exif) + "/" + R.drawable.loal_exif);
        ImageRequest imageRequest = ImageRequestBuilder.newBuilderWithSource(uri)
    ...
    private void loadFirstAvailableImg() {
        Uri uri0 = Uri.parse(UriUtil.LOCAL_RESOURCE_SCHEME+"://" + getResources().getResourcePackageName(R.drawable.xiaowanzi) + "/" + R.drawable.local_first_330_220);
    ...
    private void loadModifyImg() {
        Uri uri = Uri.parse(UriUtil.LOCAL_RESOURCE_SCHEME+"://" + getResources().getResourcePackageName(R.raw.local_img) + "/" + R.raw.local_img);
